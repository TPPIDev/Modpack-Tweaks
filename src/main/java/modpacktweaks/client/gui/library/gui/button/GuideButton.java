package modpacktweaks.client.gui.library.gui.button;
...
{
	private ResourceLocation myButtons = new ResourceLocation("modpacktweaks", ConfigurationHandler.guideSkin == 0 ? "textures/gui/guiGuide.png" : "textures/gui/guiGuide_alt.png");
