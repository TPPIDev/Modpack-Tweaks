...
public class ModpackTweaksBook extends ItemEditableBook
{
	public ModpackTweaksBook(int par1)
	{
		super(par1);
	...
	{
		if (stack.stackTagCompound == null || !stack.getTagCompound().getString("version").equals(ModpackTweaks.VERSION))
		{
